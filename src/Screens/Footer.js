...
const Footer = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_v74qsm3', 'template_sekg90b', form.current, 'ezq7r42lSTJtm37Xf')
            .then((result) => {
                ...
                <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                    <div class="mx-auto max-w-sm lg:max-w-none">
                        ...
                        <div class="mt-6 flex justify-center gap-4 lg:justify-start">
                            ...
                            <a
                                class="text-orange-600 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
                                href=""
                                target="_blank"
                                rel="noreferrer"
                            >
                            ...
                            <a
                                class="text-blue-400 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
                                href=""
                                target="_blank"
                                rel="noreferrer"
                            >
